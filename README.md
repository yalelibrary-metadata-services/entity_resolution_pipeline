...
*This codebase was developed using Anthropic's Claude 3.7 Sonnet model (Extended mode).*
The project instructions and initial prompt used to define the project requirements are in the [prompts](prompts) folder.
